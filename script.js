document.addEventListener('DOMContentLoaded', function() {
    var videoData = {
        documentary: [
            { src: '视频合集/documentary-1.mp4', poster: 'posters/documentary-1.jpg', title: 'AI纪录片《何以为家》', desc: { 光影: '低色温暖调柔光为主，逆光剪影强化身份迷失的视觉隐喻，局部硬光打亮面部制造明暗割裂', 镜头: '固定长镜头保持纪实凝视感，缓慢推拉引导沉浸，全景→中景→特写递进构建情感压迫', 风格: '纪实人文风，诗意留白叙事，弱化旁白依赖视觉情绪传递', 节奏: '沉稳舒缓，留白与沉默交替推进，情绪在压抑与释放间缓慢蓄力' } },
            { src: '视频合集/documentary-2.mp4', poster: 'posters/documentary-2.jpg', title: 'AI纪录片《沁园春·雪》', desc: { 光影: '高色温冷调漫射光营造雪域苍茫，侧逆光勾勒山脊轮廓，晨昏金光穿插制造冷暖转折', 镜头: '航拍大全景开篇建立山河格局，缓慢横移展现纵深，景别递进对应诗词起承转合', 风格: '史诗诗意风，东方写意美学，视觉节奏对仗诗词韵律', 节奏: '宏大舒缓，气势铺陈与意境留白交替，长镜头延展空间感' } }
        ],
        ads: [
            { src: '视频合集/ads-1.mp4', poster: 'posters/ads-1.jpg', title: '爆炸盐，炸掉所有烦恼', desc: { 光影: '高对比硬光制造爆破质感，瞬间强闪光效模拟爆炸冲击，冷白主光+暗部压深强化科技冷峻感', 镜头: '快速推拉+微距特写捕捉颗粒飞溅，全景与极近特写间跳切，以视觉震荡传递"炸裂"概念', 风格: '科技爆破风，以爆炸视觉隐喻情绪释放，高饱和冷色调构建品牌科技感', 节奏: '爆裂快切，毫秒级闪帧制造冲击峰值，静→爆→静三段式节奏强化记忆点' } },
            { src: '视频合集/ads-2.mp4', poster: 'posters/ads-2.jpg', title: '沐萌美，油污跑光亮晶晶', desc: { 光影: '高调柔光营造清透质感，自然侧光勾勒产品光泽，过曝高光区暗示洁净效果', 镜头: '中景生活场景→特写产品细节递进，旋转环绕展示去污过程，浅景深聚焦清洁瞬间', 风格: '清新生活风，明快视觉调性，以干净画面语言呼应产品功能诉求', 节奏: '轻快律动，问题→解决短促切换，结尾定格亮洁画面强化品牌印象' } },
            { src: '视频合集/ads-3.mp4', poster: 'posters/ads-3.jpg', title: '一滴浓，一身净', desc: { 光影: '动态侧光勾勒运动肌肉线条，逆光轮廓光强化身体张力，冷暖光交替映射状态转换', 镜头: '跟拍捕捉运动轨迹，升格慢动作放大力量瞬间，全身→局部快速切换传递活力', 风格: '运动活力风，力量美学，高对比高饱和视觉强化品牌能量感', 节奏: '快慢交替，慢动作蓄力→正常速度释放，爆发节奏驱动情绪攀升' } },
            { src: '视频合集/ads-4.mp4', poster: 'posters/ads-4.jpg', title: '油污净，秒除污', desc: { 光影: '去污前冷灰低调→去污后暖白高调，色温转换直映清洁效果，侧光打亮洁净表面', 镜头: '微距特写污渍细节→中景展示清洁过程，对比构图左右分屏或前后跳切', 风格: '功能演示风，视觉对比为核心策略，干净利落画面语言呼应"秒除"诉求', 节奏: '干脆利落，问题→解决两拍式快切，零冗余节奏传递高效去污产品力' } },
            { src: '视频合集/ads-5.mp4', poster: 'posters/ads-5.jpg', title: 'AD钙，用心包裹儿时科幻梦', desc: { 光影: '霓虹冷光与暖调柔光交织营造科幻梦境质感，光晕漫射柔化边缘，低角度光打亮产品制造童话光环', 镜头: '仰拍广角营造儿童仰望视角，微距捕捉产品细节，奇幻大场景与产品特写间跳跃', 风格: '童趣科幻风，梦幻视觉包裹产品，以想象力叙事替代功能说教', 节奏: '奇幻跳跃，场景快速切换模拟儿童注意力节奏，惊喜感持续输出' } },
            { src: '视频合集/ads-6.mp4', poster: 'posters/ads-6.jpg', title: '陪你酸酸甜甜，陪你可可爱爱', desc: { 光影: '暖调逆光营造柔美轮廓，柔焦光晕包裹画面，自然散射光制造温馨氛围，高光微过曝传递甜蜜感', 镜头: '浅景深特写聚焦表情与产品，缓慢摇移跟随情感流动，中近景为主保持亲密感', 风格: '温馨治愈风，柔美视觉调性，以陪伴感叙事替代产品推销', 节奏: '温柔舒缓，情感递进如呼吸般自然，甜蜜与可爱情绪交替流淌' } },
            { src: '视频合集/ads-7.mp4', poster: 'posters/ads-7.jpg', title: '东方美学，飘逸灵动', desc: { 光影: '柔光漫射营造梦幻氛围，彩色滤光片创造艺术感光影，水波纹反射增添灵动质感', 镜头: '慢动作捕捉飘逸动感，推镜头聚焦设计亮点，全景展现造型→中景展示搭配→近景捕捉面料质感', 风格: '东方时尚风，融合美学，以飘逸视觉语言传递品牌艺术调性', 节奏: '优雅灵动，场景流转如丝般顺滑，艺术感与商业感平衡推进' } }
        ],
        game: [
            { src: '视频合集/game-1.mp4', poster: 'posters/game-1.jpg', title: '三角洲委托——多元素引流', desc: { 光影: '多光源混合打光，冷暖交替营造奇幻层次感，体积光穿透雾气制造空间纵深', 镜头: '航拍→跟拍→特写多视角快速切换，景别跳变串联多元游戏元素，横移展现场景广度', 风格: '奇幻混搭风，多元视觉元素密集输出，以丰富度吸引不同玩家群体', 节奏: '快慢交错，元素轮番呈现保持新鲜感，信息密度高但不杂乱' } },
            { src: '视频合集/game-2.mp4', poster: 'posters/game-2.jpg', title: '三角洲委托——冲突化引流', desc: { 光影: '高对比硬光强化金属质感，频闪光效模拟战场爆炸，冷蓝主调+橙红爆炸光制造冲突色温对撞', 镜头: '手持晃动制造临场冲击，快速推拉捕捉战斗瞬间，远景战场与近景机甲间急速切换', 风格: '硬核科幻风，冲突美学，以对抗张力驱动观看欲', 节奏: '急促快切，战斗节奏持续高压，爆炸闪帧制造视觉峰值' } },
            { src: '视频合集/game-3.mp4', poster: 'posters/game-3.jpg', title: '三角洲委托——剧情化引流', desc: { 光影: '低调暗调为主，侧光勾勒暗黑轮廓，局部点光源制造悬疑明暗，深色压暗留出恐惧想象空间', 镜头: '缓慢推近制造压迫逼近感，景深虚化隐藏威胁，中景→特写收缩视野引发好奇与不安', 风格: '暗黑叙事风，哥特美学，以悬念与未知驱动持续观看', 节奏: '压抑缓起，悬念递进如暗流涌动，在窒息感中蓄积爆发' } },
            { src: '视频合集/game-4.mp4', poster: 'posters/game-4.jpg', title: '三角洲委托——洛克王国与三角洲的剧情化、冲突化叙事', desc: { 光影: '自然光为基底，魔幻光效点缀超现实感，冷暖光随叙事情绪转换，体积光营造史诗空间纵深', 镜头: '大全景建立世界观，横移展现场景广度，叙事段中景推进剧情，冲突段快速切换制造对抗', 风格: '开放世界风，史诗叙事，双IP碰撞制造跨世界观奇观', 节奏: '叙事与冲突交替，张弛有度，剧情铺垫→冲突爆发→悬念收尾三段式推进' } },
            { src: '视频合集/game-5.mp4', poster: 'posters/game-5.jpg', title: '三角洲委托——真人化仿真叙事', desc: { 光影: '仿真自然光为主，环境光反射模拟真实光感，避免人工补光痕迹，以纪实光效消解AI生成感', 镜头: '肩扛跟拍制造呼吸感，纪实视角保持临场真实，中近景为主贴近人物，偶发晃动增强仿真可信度', 风格: '伪纪实风，仿真叙事，以真实感消解虚拟边界，模糊AI与实拍界限', 节奏: '纪实节奏，沉浸推进，去戏剧化处理保持生活流质感' } },
            { src: '视频合集/game-6.mp4', poster: 'posters/game-6.jpg', title: '三角洲委托——生活化叙事引流', desc: { 光影: '灰调漫射光营造废墟阴郁，低色温微暖光暗示生存希望，阴天散射光消除硬影传递末日氛围', 镜头: '固定镜头凝视荒芜环境，缓慢横移展现生存空间，中景记录日常动作，克制运镜反衬生存沉重', 风格: '末日写实风，荒凉美学，以生活化细节消解末日奇观化', 节奏: '缓慢沉重，生存压迫感持续低频，偶发危机瞬间打破日常' } },
            { src: '视频合集/game-7.mp4', poster: 'posters/game-7.jpg', title: '短剧化AI视频', desc: { 光影: '侧逆光勾勒武侠人物轮廓，明暗对比强化招式力量感，暖黄烛光与冷月光的色温对立营造江湖氛围', 镜头: '升格慢动作放大招式瞬间，快速切换捕捉对攻节奏，全景→特写定格关键帧强化武术美感', 风格: '武侠动作风，东方暴力美学，以短剧叙事框架承载武打奇观', 节奏: '动静交替，招式蓄力慢放→交锋快切，武侠韵律驱动叙事推进' } }
        ],
        real: [
            { src: '视频合集/real-2.mp4', poster: 'posters/real-2.jpg', title: '纪录片——东兴电商宣传', desc: { 光影: '混合光源，室内暖光营造电商工作温度，室外自然光展现物流实景，补光均匀保持画面通透', 镜头: '采访固定镜头保持叙事稳定，跟拍展现物流动态，中景叙事→特写捕捉人物情绪', 风格: '现代纪实风，发展叙事，以人物故事承载产业变迁', 节奏: '稳健推进，数据呈现与人物故事交织，理性与感性双线并行' } },
            { src: '视频合集/real-3.mp4', poster: 'posters/real-3.jpg', title: '实拍纪录片——五四青年节', desc: { 光影: '明亮自然光为主，高调画面传递青春朝气，侧光勾勒青年轮廓，逆光光晕营造理想主义氛围', 镜头: '动态跟拍捕捉青年活力，升格慢动作定格奋斗瞬间，中近景为主保持情感亲近', 风格: '青春纪实风，朝气视觉调性，以真实力量替代口号式表达', 节奏: '明快昂扬，激情递进，从个体奋斗到群体共鸣逐步升温' } },
            { src: '视频合集/real-1.mp4', poster: 'posters/real-1.jpg', title: '实拍纪录片——广西三月三', desc: { 光影: '自然日光为主，暖调环境光还原节日热烈，逆光拍摄歌舞剪影强化仪式感，室内烛光补充人文温度', 镜头: '纪实跟拍捕捉民俗自然感，仪式段落固定镜头保持庄重，全景→中景→特写传递文化厚度', 风格: '民族纪实风，人文关怀视角，以真实记录替代奇观化呈现', 节奏: '节庆律动，仪式庄重与生活欢快交织，情绪在传统与现代间自然流转', 荣誉: '广西日报年度最佳宣传片、广西自治区党委宣传部表彰' } }
        ],
        agent: [
            {
        ...
        if (v.image || v.warmBg) {
            ...
            if (showcaseVideo) {
                ...
                var playWhenReady = function() {
                    // Remove poster only after video first frame renders
                    showcaseVideo.onplaying = function() {
                        showcaseVideo.onplaying = null;
                        showcaseVideo.removeAttribute('poster');
                    };
                ...
                if (showcaseVideo.readyState >= 3) {
                    ...
                    showcaseVideo.onerror = function() {
                        ...
                        var catEl = document.getElementById('showcase-cat');
                        if (catEl) catEl.textContent = '视频加载失败';
                        var titleEl = document.getElementById('showcase-title');
                        if (titleEl) titleEl.textContent = '请检查网络连接后重试';
                        showcaseVideo.removeAttribute('poster');
                    };
                }
                showcaseVideo.load();
