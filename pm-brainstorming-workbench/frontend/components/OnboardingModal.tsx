...
export function OnboardingModal() {
  ...
  useEffect(() => {
    ...
    const handleEscape = (e: KeyboardEvent) => {
      if (e.key === "Escape") setOnboardingOpen(false);
    };
    document.addEventListener("keydown", handleEscape);
    return () => document.removeEventListener("keydown", handleEscape);
  }, [isOpen, setOnboardingOpen]);
          ...
          {step === "welcome" && (
            <div className="text-center">
              ...
              <button
                ...
                aria-label="开始配置"
                className="h-11 px-8 btn-gradient font-semibold rounded-xl focus-visible:ring-2 focus-visible:ring-amber-500/50 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-white"
              >
                开始配置
              </button>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <button
                  ...
                  aria-label="开始脑暴"
                  className="h-11 px-8 btn-gradient font-semibold rounded-xl focus-visible:ring-2 focus-visible:ring-amber-500/50 focus-visible:outline-none"
                >
                  开始脑暴
                </button>
              </div>
